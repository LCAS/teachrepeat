...
ws = '/home/ros/aoc_strawberry_scenario_ws/' # Chgange this to your workspace

# Function to list directories containing .db3 files
def get_map_names(directory=ws):
...
def plot_odom_data():
    ...
    file1 = f"{ws}/{map_name}/odom_data.csv"
    file2 = f"{ws}/{map_name}/odom_data2.csv"
